...
Product.create(category: "Accessoire", price: 2.97, title: "Thermomètre avec ventouse", description: "Un thermomètre: ça sert à savoir la température de l'eau.", quantity: 10, animal_type: "Aquariophilie")
#https://zoo-max.com/fr/product/serin-2-lbs-3/?v=c4782f5abe5c
Product.create(category: "Nourriture", price: 7.49, title: "Vitomax pour serin", description: "Vitomax est une nourriture enrichie de vitamines & minéraux.", quantity: 10, animal_type: "Oiseaux")
...
Product.create(category: "Jouet", price: 16.99, title: "Poisson électrique", description: "Jouet poisson électrique à l'herbe à chat.", quantity: 10, animal_type: "Chat")
...
Product.create(category: "Cage", price: 209.99, title: "Clapier surélevé en bois à 2 étages", description: "Matériau : pin, bois de sapin, fil d'acier. Couleur : Poids du filet : Dimensions totales : Dimensions de la porte en maille HTop : Dimensions de la porte en bois HTop : 27,6 x 12,8 cm. 12,8 x 15,7 cm.", quantity: 10, animal_type: "Petits Animaux")
...
Product.create(category: "Terrarium", price: 279.81, title: "Terrarium en verre", description: "Terrarium en verre de 45,7 x 45,7 x 45,7 cm pour petit reptiles ou amphibiens", quantity: 10, animal_type: "Reptiles et Amphibiens")
...
Product.create(category: "Transport", price: 53.99, title: "petit pet voyageur", description: "De petite taille et idéal pour les petits chiens", quantity: 10, animal_type: "Chiens")
...
Product.create(category: "Aquarium", price: 332.57, title: "Aquarium 30 gallon", description: "Aquarium de 30 gallon en acrylique", quantity: 10, animal_type: "Aquariophilie")
...
Product.create(category: "Accessoire", price: 17.99, title: "Pelle a litière", description: "Pelle en alluminium pour nettoyer la litière", quantity: 10, animal_type: "Chats")
...
Product.create(category: "Nourriture", price: 21.99, title: "Bâtonnets flottants", description: "Nourriture pour tortue sousforme de batonnêts flottants", quantity: 10, animal_type: "Reptiles et Amphibiens")
...
Product.create(category: "Cage", price: 131.80, title: "Cage de vol", description: "Cage verte adaptée pour les petits oiseaux", quantity: 10, animal_type: "Oiseaux")